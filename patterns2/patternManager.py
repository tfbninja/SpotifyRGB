...
class patternManager:
	...
	def nextRandomPattern(self):
		...
		if can_be_disco:
			...
			valid_choices.pop(self.pattern_list.index(self.current_pattern))
		else:
	...
	def nextPattern(self, pattern_n):
		...
		if self.pattern_list[pattern_n].getName() != self.current_pattern.getName():
			self.current_pattern = self.pattern_list[pattern_n]
